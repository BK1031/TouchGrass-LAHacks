...
class DrawerPreviewCard extends StatefulWidget {
  ...
  const DrawerPreviewCard({super.key, required this.currentGame});
            ...
            children: [
              Row(
                children: [
                  ...
                  Text(widget.currentGame.players.length.toString(), style: const TextStyle(fontSize: 18),),
                ],
              ),
              Row(
                children: [
                  ...
                  const Padding(padding: EdgeInsets.all(4)),
                  Text(widget.currentGame.players.firstWhere((p) => p.id == currentUser.id, orElse: () => Player()).hits.toString(), style: const TextStyle(fontSize: 18),),
                ],
              ),
              Row(
                children: [
                  ...
                  const Padding(padding: EdgeInsets.all(4)),
                  Text(widget.currentGame.players.firstWhere((p) => p.id == currentUser.id, orElse: () => Player()).attempts.toString(), style: const TextStyle(fontSize: 18),),
                ],
              ),
              Row(
                children: [
                  ...
                  const Padding(padding: EdgeInsets.all(4)),
                  Text((widget.currentGame.players.indexWhere((p) => p.id == currentUser.id) + 1).toString(), style: const TextStyle(fontSize: 18),),
                ],
              )
            ],
          ),
